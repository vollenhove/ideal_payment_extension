...
desc 'Generate documentation for the ideal_payment_extension extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'IdealPaymentExtensionExtension'
...
desc 'Test the ideal_payment_extension extension.'
